        ...
        <div className="grid gap-5 xl:grid-cols-[1fr_420px]">
          <div className="grid gap-4">
            <section className="p-4 flex flex-col gap-4">
              <p className="text-2xl font-bold text-orange-300">Próxima clase</p>
              {clasesLoading ? (
                ...
                <div className="relative grid gap-1 text-sm sm:grid-cols-3 bg-blue-200 p-3 rounded">
                  ...
                  <button
                    ...
                    className="absolute top-0 bottom-0 right-3 text-sm font-semibold text-slate-900 hover:text-orange-400 transition"
                  >
            ...
            <section className="p-4">
              <h2 className="text-2xl font-bold tracking-[-0.03em] text-orange-300">Mi horario</h2>
            ...
            <section className="p-4">
              <h2 className="text-2xl font-bold tracking-[-0.03em] text-orange-300">Últimas asistencias</h2>
          ...
          <aside className="p-4">
            <h2 className="text-2xl font-bold tracking-[-0.03em] text-orange-300">Reservar aula</h2>
            ...
            <form className="mt-5 grid gap-4" onSubmit={handleReservation}>
              ...
              <button type="submit" disabled={submitting || !selectedRoom}
                className="bg-orange-300 px-4 py-3 rounded font-bold text-white hover:bg-orange-400 disabled:opacity-50 disabled:cursor-not-allowed">
